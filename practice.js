...
function showValues(obj) {
  let everything = "";
  for (value in obj) {
    everything = everything + `${obj[value]}`;
  }
  return everything;
}
...
function makeCard(cardNumber, expirationDate, securityCode) {
  const creditCard = {};
  creditCard["Card Number"] = cardNumber;
  creditCard["Expiration Date"] = expirationDate;
  creditCard["Security Code"] = securityCode;
  return creditCard;
}
...
for (num in deleteTheBigNumbers) {
